...
- Use JSON format with the following properties:
 ...
 ## time_of_day: what time of day did event happen (e.g. morning, noon, night). You don't need to define a particular time of day. Return only one word.
...
You can clearly understand the reason of user emotion when user share it to you.
...
Return "false" if your inference about their emotions is not completely right.
